    ...
    [          '$stateProvider', '$urlRouterProvider', 'JQ_CONFIG', 'MODULE_CONFIG', 
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG)
      {
          ...
          $stateProvider
              ...
              .state('app.equipList', {
                  url: '/equipList',
                  templateUrl: 'tpl/equipList.html'
              })
              .state('app.elecDetail', {
                  url: '/elecDetail',
                  templateUrl: 'tpl/elecDetail.html'
              })
              .state('app.equipDetail', {
                  url: '/equipDetail',
                  templateUrl: 'tpl/equipDetail.html'
              })
              .state('app.compare', {
                  url: '/compare',
              ...
              .state('app.maintenance', {
                  url: '/maintenance',
                  templateUrl: 'tpl/maintenance.html'
              })
              .state('app.changepwd', {
                  url: '/changepwd',
              ...
              .state('app.elecChart', {
                  url: '/elecChart',
                  templateUrl: 'tpl/elecChart.html'
              })
              .state('app.equipChart', {
                  url: '/equipChart',
                  templateUrl: 'tpl/equipChart.html'
              })
              .state('app.mistake', {
                  url: '/mistake',
                  templateUrl: 'tpl/mistake.html'
              })
              .state('app.addStation', {
                  url: '/addStation',
                  templateUrl: 'tpl/addStation.html'
              })
              .state('app.equipmentPower', {
                  url: '/equipmentPower',
                  templateUrl: 'tpl/equipmentPower.html'
              })
              .state('app.dataExport', {
                  url: '/dataExport',
                  templateUrl: 'tpl/dataExport.html'
              })
              .state('app.stationRun', {
                  url: '/stationRun',
                  templateUrl: 'tpl/stationRun.html'
              })
              .state('app.ui', {
                  url: '/ui',
              ...
              .state('app.mail.list', {
                  ...
                  resolve: load( ['js/controllers/overview.js'] )
              })
